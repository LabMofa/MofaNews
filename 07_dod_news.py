...
URL_DEFENSE_RSS = "https://www.defense.gov/DesktopModules/ArticleCS/RSS.ashx?max=10&ContentType=1&Site=945"

def scrape_latest_items(url, max_items=3):
    headers = {
    ...
    latest_items = []
    for item in items[:max_items]:  # Limit to the latest 3 items
...
latest_items = scrape_latest_items(URL_DEFENSE_RSS)
